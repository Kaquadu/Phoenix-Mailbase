defmodule MailbaseWeb.UserControllerTest do
  use MailbaseWeb.ConnCase

  alias Mailbase.Accounts

  @create_attrs %{host_mail: "some host_mail", host_password: "some host_password", login_mail: "some login_mail", login_password: "some login_password"}
  ...
  describe "update user" do
    ...
    test "redirects when data is valid", %{conn: conn, user: user} do
      ...
      assert html_response(conn, 200) =~ "some updated host_mail"
    end
