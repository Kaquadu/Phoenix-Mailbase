defmodule Mailbase.ListsTest do
  ...
  describe "lists" do
    ...
    @valid_attrs %{name: "some name", owner: "some owner", uuid: "some uuid"}
    @update_attrs %{name: "some updated name", owner: "some updated owner", uuid: "some updated uuid"}
    @invalid_attrs %{name: nil, owner: nil, uuid: nil}
    ...
    test "create_list/1 with valid data creates a list" do
      ...
      assert list.owner == "some owner"
      assert list.uuid == "some uuid"
    end
    ...
    test "update_list/2 with valid data updates the list" do
      ...
      assert list.owner == "some updated owner"
      assert list.uuid == "some updated uuid"
    end
  ...
  describe "lits" do
    ...
    test "list_lits/0 returns all lits" do
      list = list_fixture()
      assert Lists.list_lits() == [list]
    end
